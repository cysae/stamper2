...
input DocumentCreateManyWithoutOwnerInput {
  create: [DocumentCreateWithoutOwnerInput!]
  connect: [DocumentWhereUniqueInput!]
}

input DocumentCreateWithoutOwnerInput {
  name: String!
}
...
input DocumentUpdateManyWithoutOwnerInput {
  create: [DocumentCreateWithoutOwnerInput!]
  delete: [DocumentWhereUniqueInput!]
  connect: [DocumentWhereUniqueInput!]
  disconnect: [DocumentWhereUniqueInput!]
  update: [DocumentUpdateWithWhereUniqueWithoutOwnerInput!]
  upsert: [DocumentUpsertWithWhereUniqueWithoutOwnerInput!]
}

input DocumentUpdateWithoutOwnerDataInput {
  name: String
}

input DocumentUpdateWithWhereUniqueWithoutOwnerInput {
  where: DocumentWhereUniqueInput!
  data: DocumentUpdateWithoutOwnerDataInput!
}

input DocumentUpsertWithWhereUniqueWithoutOwnerInput {
  where: DocumentWhereUniqueInput!
